        ...
        */
        ...
        var debouncedDragOverEnter = debounce(function (sortableElement, element, pageX, pageY) {
            ...
            if (Array.from(sortableElement.children).indexOf(element) > -1) {
                ...
                store(sortableElement).placeholder.style.marginLeft = sortableElement.parentNode.scrollLeft+'px';
                //el = el.node;
                if (placeAfter) {
                    ...
                    //insertBefore(element, '<div style="min-height: 45px; min-width: 40px; color:red"></div>');
                }
